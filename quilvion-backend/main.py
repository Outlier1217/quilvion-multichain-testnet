...
ML (XGBoost fraud detection) + LLM (Claude) integrated
"""
...
app = FastAPI(
    ...
    description="ML fraud detection + Claude LLM for Quilvion multichain commerce",
    version="1.0.0",
    lifespan=lifespan,
)
...
app.include_router(llm.router,      prefix="/api/llm",      tags=["LLM (Claude)"])
